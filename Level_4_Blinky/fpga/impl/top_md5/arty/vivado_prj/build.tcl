...
#
# Generated by Vivado on Fri Feb 01 14:52:15 PST 2019
...
#
#    "/home/brandonb/Projects/ClusterFights/MunchMan/Level_4_Blinky/fpga/hdl/md5_lib/cmd_parser.v"
#    "/home/brandonb/Projects/ClusterFights/MunchMan/Level_4_Blinky/fpga/hdl/md5_lib/hash_op.v"
#    "/home/brandonb/Projects/ClusterFights/MunchMan/Level_4_Blinky/fpga/hdl/md5_lib/md5core.v"
#    "/home/brandonb/Projects/ClusterFights/MunchMan/Level_4_Blinky/fpga/hdl/md5_lib/parallel_bus.v"
#    "/home/brandonb/Projects/ClusterFights/MunchMan/Level_4_Blinky/fpga/hdl/md5_lib/string_process_match.v"
#    "/home/brandonb/Projects/ClusterFights/MunchMan/Level_4_Blinky/fpga/hdl/top_lib/top_md5.v"
#    "/home/brandonb/Projects/ClusterFights/MunchMan/Level_4_Blinky/fpga/impl/top_md5/arty_s7_md5.v"
#    "/home/brandonb/Projects/ClusterFights/MunchMan/Level_4_Blinky/fpga/impl/top_md5/arty_s7_md5.xdc"
#
#*****************************************************************************************
...
set files [list \
 [file normalize "${origin_dir}/../../../hdl/md5_lib/cmd_parser.v"] \
 [file normalize "${origin_dir}/../../../hdl/md5_lib/hash_op.v"] \
 [file normalize "${origin_dir}/../../../hdl/md5_lib/md5core.v"] \
 [file normalize "${origin_dir}/../../../hdl/md5_lib/parallel_bus.v"] \
 [file normalize "${origin_dir}/../../../hdl/md5_lib/string_process_match.v"] \
 [file normalize "${origin_dir}/../../../hdl/top_lib/top_md5.v"] \
 [file normalize "${origin_dir}/../arty_s7_md5.v"] \
]
...
set obj [get_filesets sources_1]
set_property -name "top" -value "arty_s7_md5" -objects $obj
...
set file "[file normalize "$origin_dir/../arty_s7_md5.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/../arty_s7_md5.xdc"
...
if {[string equal [get_runs -quiet synth_2] ""]} {
    create_run -name synth_2 -part xc7s50csga324-1 -flow {Vivado Synthesis 2018} -strategy "Flow_AreaOptimized_high" -report_strategy {No Reports} -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet synth_3] ""]} {
    create_run -name synth_3 -part xc7s50csga324-1 -flow {Vivado Synthesis 2018} -strategy "Flow_AreaOptimized_high" -report_strategy {No Reports} -constrset constrs_1
} else {
  set_property strategy "Flow_AreaOptimized_high" [get_runs synth_3]
...
set_property -name "steps.synth_design.args.control_set_opt_threshold" -value "1" -objects $obj
set_property -name "steps.synth_design.args.shreg_min_size" -value "7" -objects $obj

# Create 'synth_4' run (if not found)
if {[string equal [get_runs -quiet synth_4] ""]} {
    create_run -name synth_4 -part xc7s50csga324-1 -flow {Vivado Synthesis 2018} -strategy "Flow_AreaOptimized_high" -report_strategy {No Reports} -constrset constrs_1
} else {
  set_property strategy "Flow_AreaOptimized_high" [get_runs synth_4]
...
set_property -name "steps.synth_design.args.directive" -value "AreaOptimized_high" -objects $obj
set_property -name "steps.synth_design.args.retiming" -value "1" -objects $obj
set_property -name "steps.synth_design.args.control_set_opt_threshold" -value "4" -objects $obj
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xc7s50csga324-1 -flow {Vivado Implementation 2018} -strategy "Area_ExploreWithRemap" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
...
if {[string equal [get_runs -quiet impl_2] ""]} {
    create_run -name impl_2 -part xc7s50csga324-1 -flow {Vivado Implementation 2018} -strategy "Vivado Implementation Defaults" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_2
} else {
...
if {[string equal [get_runs -quiet impl_3] ""]} {
    create_run -name impl_3 -part xc7s50csga324-1 -flow {Vivado Implementation 2018} -strategy "Area_ExploreWithRemap" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_3
} else {
...
if {[string equal [get_runs -quiet impl_4] ""]} {
    create_run -name impl_4 -part xc7s50csga324-1 -flow {Vivado Implementation 2018} -strategy "Vivado Implementation Defaults" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_4
} else {
